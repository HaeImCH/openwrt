...
export Op_name="CH OpenWrt owo"                    # 修改主机名称为OpenWrt(填0为不作修改)
...
export DNS_Settings="1.1.1.1"       # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
...
export Customized_Information="By CH $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
